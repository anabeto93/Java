...
public class RunThread{
	public static void main(String args[]) throws InterruptedException{
		//Thread firstThread = new UserInteraction(); //only applies when extends Thread
		Thread firstThread = new Thread(new UserInteraction());
		firstThread.start();
		//Thread secondThread = new ComputeLog(); //same as for firstThread
...
class ComputeLog implements Runnable{ //error because TwoThreads.java contains them
